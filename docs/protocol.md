        # Metaoverfit Paper: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/metaoverfit-paper.git

        ## Objective

        MetaOverfit Paper investigates overfitting in meta-regression models, quantifying the risk of spurious moderator findings and proposing cross-validation corrections.
        ...
        - Code: https://github.com/mahmood726-cyber/metaoverfit-paper.git
        - Dashboard: https://mahmood726-cyber.github.io/metaoverfit-paper/
